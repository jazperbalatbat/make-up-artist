...
let wcimg = document.querySelector(".wc_img");
...
// console.log(Math.floor(Math.random() * 5) + " number");

// wcimg.style.cssText = "background-image:url(" + apPath[1] + "); background-size:cover; width: 100%; height: 100%;";
...
//     wcimg.style.cssText = "background:url(" + apPath[Math.floor(Math.random() * 5)] + "); background:cover;" +
//         " background-size:cover; width: 100%; height: 100%; transition: 1500ms ease-in-out;"+
